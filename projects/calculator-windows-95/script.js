...
// Load audio files
const clickSound = new Audio('./sounds/mouse-click.mp3'); // Generic button click sound
const equalsSound = new Audio('./sounds/mouse-click.mp3'); // Equals button sound
const errorSound = new Audio('./assets/error.mp3'); // Error sound (optional)
...
buttons.forEach(button => {
    button.addEventListener("click", function () {
        ...
        // Play button click sound (default)
